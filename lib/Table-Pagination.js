...
var TablePagination = function (_Component) {
    ...
    function TablePagination(props) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TablePagination).call(this, props));

        _this.state = {
            activePage: 0,
            pageCount: Math.ceil(_this.props.totalCount / _this.props.perPageItemCount)
        };
    ...
    _createClass(TablePagination, [{
        ...
        value: function render() {
            ...
            var perPageItemCount = _props3.perPageItemCount;
            var totalCount = _props3.totalCount;
            var className = _props3.className;
            var paginationClassName = _props3.paginationClassName;
